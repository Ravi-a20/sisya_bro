...
def execute_command(command):
    ...
    try:
        ...
        # Check for various ways to say "open youtube in chrome"
        if "open youtube in brave" in command or "open youtube" in command or "youtube" in command or "you tube" in command:
            print("Opening YouTube in brave...")
            subprocess.run(["start", "brave", "https://www.youtube.com"], shell=True)
        elif "open video" in command or "video" in command:
            print("Opening YouTube in brave...")
            subprocess.run(["start", "brave", "https://www.youtube.com/watch?v=wwmLQBzmBKk"], shell=True)
        elif "open chrome" in command or "google chrome" in command or "chrome" in command:
